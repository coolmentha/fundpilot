...
When multiple root causes are plausible and evidence is incomplete, update your beliefs proportionally to new evidence
rather than clinging to initial assumptions.
...
Never express binary certainty when evidence is incomplete. Use "most likely", "plausible but unlikely", "worth
investigating".
