...
交易信号页同时展示跨基金待处理信号；用户可在该页采纳或忽略。采纳后生成 `PENDING` 交易，后续统一进入操作确认工作台。
...
- 实现：[DisciplineStrategyCommandHandler](../../backend/src/main/java/com/fundpilot/backend/discipline/application/command/strategymanagement/DisciplineStrategyCommandHandler.java)、[AdviceLifecycleCommandHandler](../../backend/src/main/java/com/fundpilot/backend/discipline/application/command/advicelifecycle/AdviceLifecycleCommandHandler.java)、[AdviceGenerationCommandHandler](../../backend/src/main/java/com/fundpilot/backend/discipline/application/command/advicegeneration/AdviceGenerationCommandHandler.java)、[AdviceResponseCommandHandler](../../backend/src/main/java/com/fundpilot/backend/discipline/application/command/adviceresponse/AdviceResponseCommandHandler.java)、[AdvicePolicy](../../backend/src/main/java/com/fundpilot/backend/discipline/domain/advice/AdvicePolicy.java)（建议可回应性与卖出份额判定）
- 测试：[AdviceLifecycleCommandHandlerTest](../../backend/src/test/java/com/fundpilot/backend/discipline/application/command/advicelifecycle/AdviceLifecycleCommandHandlerTest.java)、[DisciplineStrategyCommandHandlerTest](../../backend/src/test/java/com/fundpilot/backend/discipline/application/command/strategymanagement/DisciplineStrategyCommandHandlerTest.java)、[AdviceGenerationCommandHandlerTest](../../backend/src/test/java/com/fundpilot/backend/discipline/application/command/advicegeneration/AdviceGenerationCommandHandlerTest.java)、[AdviceResponseCommandHandlerTest](../../backend/src/test/java/com/fundpilot/backend/discipline/application/command/adviceresponse/AdviceResponseCommandHandlerTest.java)、[AdvicePolicyTest](../../backend/src/test/java/com/fundpilot/backend/discipline/domain/advice/AdvicePolicyTest.java)
