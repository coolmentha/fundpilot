...
class ImportedHoldingGatewayImplTest {
    ...
    void createsHoldingThroughPublishedModuleApis() {
        ...
        var gateway = new ImportedHoldingGatewayImpl(products, portfolioFunds, groups, onboarding,
        ...
        verify(onboarding).onboard(any(PortfolioFundOnboardingApi.OnboardPortfolioFund.class));
