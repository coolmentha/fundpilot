...
public class FundReturnApi {
    ...
    public record FundReturnSnapshot(long portfolioFundId, long fundProductId, String fundCode, String fundName,
        ...
        static FundReturnSnapshot from(PortfolioReturnQueryHandler.FundReturnResult value) {
            return new FundReturnSnapshot(value.portfolioFundId(), value.fundProductId(), value.fundCode(),
                    value.fundName(),
