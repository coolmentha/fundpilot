...
import com.fundpilot.backend.marketdata.application.gateway.realtimevaluation.RealtimeMarketOverviewGateway.Sector;
...
public record SectorView(
    ...
    public static SectorView from(Sector s) {
