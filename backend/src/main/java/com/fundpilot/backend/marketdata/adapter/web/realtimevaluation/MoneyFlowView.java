...
import com.fundpilot.backend.marketdata.application.gateway.realtimevaluation.RealtimeMarketOverviewGateway.MoneyFlow;
...
public record MoneyFlowView(
    ...
    public static MoneyFlowView from(MoneyFlow s) {
