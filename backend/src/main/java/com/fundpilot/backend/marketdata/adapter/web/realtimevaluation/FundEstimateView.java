...
import com.fundpilot.backend.marketdata.application.gateway.realtimevaluation.RealtimeMarketOverviewGateway.Estimate;
...
public record FundEstimateView(
    ...
    public static FundEstimateView from(Estimate s) {
        return s == null ? null
                : new FundEstimateView(s.estimatedChangePct(), s.estimateTime(), s.baseNavDate());
    }

    public static Map<String, FundEstimateView> from(Map<String, Estimate> snapshots) {
