...
import com.fundpilot.backend.marketdata.application.gateway.realtimevaluation.RealtimeMarketOverviewGateway.IndexQuote;
...
public record IndexRealtimeView(
    ...
    public static IndexRealtimeView from(IndexQuote s) {
