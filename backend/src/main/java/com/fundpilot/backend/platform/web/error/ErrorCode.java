...
public enum ErrorCode {
    ...
    MONTHLY_DCA_BUDGET_INVALID,
    POSITION_WARNING_RATIO_INVALID,
    ...
    ALERT_RULE_CONDITION_INVALID,
    ALERT_RULE_SCOPE_INVALID,
    ALERT_RULE_TARGET_FUND_INVALID,
    ALERT_RULE_KIND_INVALID,
    ALERT_RULE_PARAMETER_INVALID,
    USER_EMAIL_INVALID,
